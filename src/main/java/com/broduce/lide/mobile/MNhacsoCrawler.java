...
public class MNhacsoCrawler extends AbstractCrawler {
...
//			System.out.println("title:"+title);
		...
		Pattern ptn = Pattern.compile("file=([^&]+.mp3)");
		Matcher mtc = ptn.matcher(body);
		if (mtc.find()) {
//			System.out.println("data:"+mtc.group(1));
			try {
				result.add(new Info(title, URLDecoder.decode(mtc.group(1),"UTF-8"), "mp3"));
